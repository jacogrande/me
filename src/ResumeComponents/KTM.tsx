...
const KTM = () => (
  <div className="container">
    ...
    <p className="description indent margin-top">
      ...
      to find a way to keep playing Magic:
      The Gathering, our favorite trading card game. There were some online versions of the game, but none of
      them had the simplicity and control that we wanted, so we decided to make
      our own. We got to work building a site with a Typescript / React
      front-end and a Node.js / Express back-end.
    </p>
    <p className="description indent">
      ...
      wasn't on the local database. This is what the deck building process looked like:
    </p>
    <img src="/covers/deck-builder.png" className="project-image" alt="Kitchen Table Magic's deck builder interface"/>
    <img src="/covers/deck.png" className="project-image" alt="Kitchen Table Magic's deck viewer interface"/>
    <p className="description indent margin-top">
      ...
      multiple seperate clients while working on this project. Here's what game lobbies looked like:
    </p>
    <img src="/covers/game-lobby.png" className="project-image" alt="Kitchen Table Magic's game lobby interface"/>
  </div>
);
