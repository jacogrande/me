...
const Pokemon = () => (
  <div className="container">
    ...
    <img src="/covers/pokemon-map.png" className="project-image" alt="Pokemon Rocket rendered game map"/>
    <p className="description indent margin-top">
    ...
    <img src="/covers/pokemon-animated.gif" className="project-image" alt="Animations in Pokemon Rocket"/>
    <p className="description indent margin-top">
      The game map, or tilemap, was stored as a two
      dimensional array of sprite and animated sprite objects, but the tilemap
      was also mapped to a permission map, a two dimensional array that would
      track the player's position and check for movement boundaries. Working on
      this project made me spend a lot of time getting comfortable with more
      complicated data types.
    </p>
    <img src="/covers/pokemon-movement.gif" className="project-image" alt="Trying to move into bondaries in Pokemon Rocket"/>
    <p className="description indent margin-top">
    ...
    <img src="/covers/pokemon-menu.gif" className="project-image" alt="Pokemon Rocket game menu"/>
    <p className="description indent margin-top">
      After 4 months of work and a codebase that was growing larger and more
      cluttered, finishing the game by myself proved too daunting of a task, but I had
      taken so much away from working on the game engine. Pokemon Rocket was the first project
      that I worked on consistently for a few hours a day, and that constant
      practice led those 4 months to be one of the most educational time periods
      in my experience programming. I learned how and when to implement
      efficient object oriented techniques in Javascript, I designed modular
      code for a clean and organized codebase, and I refined my knowledge of
